...
console.log(cokeZero instanceof DietSoda); // true
console.log(cokeZero instanceof Soda); // true
console.log(cokeZero instanceof Beverage); // true

// Try the same for cokeZero with the Juice class
console.log(cokeZero instanceof Juice); // false
